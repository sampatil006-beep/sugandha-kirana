...
class AddUdhariScreen extends ConsumerStatefulWidget {
  final CustomerModel customer;
  final LedgerModel? entry;

  const AddUdhariScreen({
    super.key,
  ...
  @override
  ConsumerState<AddUdhariScreen> createState() =>
      _AddUdhariScreenState();
}

class _AddUdhariScreenState
    extends ConsumerState<AddUdhariScreen> {
